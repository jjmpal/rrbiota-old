...
for (key in names(rds)) {
    ...
    if (!file.exists(paste0("rds-comparepseqs/alphadistribution-", key , ".rds"))) {
        ...
        alphadiversity <- readRDS(file = paste0("rds-comparepseqs/alphadistribution-", key , ".rds"))
    }
    ...
    if (length(missing) > 0) {
        ...
        if ("alphadistribution" %in% names(missing)) {
            ...
            saveRDS(alphadistribution, file = paste0("rds-comparepseqs/alphadistribution-", key , ".rds"))
        }    
