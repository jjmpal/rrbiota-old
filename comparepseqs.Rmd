...
var.CL <- c("BL_AGE", "SEX", "BMI", "CURR_SMOKE", "Q57X", 
...
```{R models}
plots <- mclapply(c2l(names(rds)), function(key) {
    pseq.species <- import_filter_data(rds[[key]],
...
```{r save session}
save.image(file = "session/comparepseq.Rdata")
```
