...
pcoa.plot <- ggplot(data=pcoa.df, aes(x=Axis.1, y=Axis.2, color = HYPERTENSION, shape = ANYDRUG)) +
...
ggsave(file = "cache/pcoa-species.png", plot=pcoa.plot, height=5, width=7, dpi = 300)
