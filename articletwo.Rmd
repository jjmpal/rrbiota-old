...
hypertension. Full model has

`r sum(results(dds$HYPERTENSION, name = "HYPERTENSION_1_vs_0")$padj < 0.05, na.rm = TRUE)`

associations for hypertension.
...
prune_lactobacillus(pseq.genus.salt, drop = FALSE) %>%
