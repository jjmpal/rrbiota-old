...
glm.pcoa <- lapply(c2l(paste0("Axis.", seq(1,5))), function(axis)
...
gsalt <- grid.arrange(
    myforestplot(adjmean.lacto.saltgroup,
                 ...
                 subtitle = "A.",
                 my_y_scale = scale_y_continuous(limits = c(3.0, 8.0), breaks = seq(0, 10, 1))),
...
ggsave(file = "cache/salt-forest.png", plot=gsalt, height=3, width=5, dpi = 300)
```
