...
```{r firmicutes bacteroides, eval = FALSE}
bfratio <- function (x) {
...
bfratio(pseq.species)

phy3 <- aggregate_taxa(pseq.species, level = "Phylum")
aggregate_taxa

 transform(aggregate_taxa(x, level = "Phylum"), "compositional")
sessionInfo()
