...
ret <- list(model_1 = adonis.species$model_1 %>% tibble::rownames_to_column(var = "response"),
     model_2 =  adonis.species$model_2 %>% tibble::rownames_to_column(var = "response"))

data.table::rbindlist(ret, id = "model_name") %>%
    dplyr::filter(response %in% c("MAP", "SYSTM"))
